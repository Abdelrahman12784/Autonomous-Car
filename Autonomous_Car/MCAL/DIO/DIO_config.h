...
#define DIO_u8PA2_VALUE		DIO_u8FLOAT
...
#define DIO_u8PC5_VALUE		DIO_u8LOW
#define DIO_u8PC6_VALUE		DIO_u8LOW
#define DIO_u8PC7_VALUE		DIO_u8LOW

/*	 	 D	*/

#define DIO_u8PD0_DIR		DIO_u8INPUT
